...
int evaluate();
int alpha(int Depth,int nx,int ny);
bool hasne(int x,int y);
int generatepoint(vector<pair<int,int> > &v);
int beta(int Depth,int nx,int ny);
int scoretable(int number,int empty1);
int countscore(vector<int> n,int now);
int priority();
...
int Kobe()
{
    ...
    while(1)
    {
        ...
        if(ret>0)
        {
            ...
            img=newimage();
            getimage(img,"F:\\MyGame\\img/black.png");
            putimage_transparent(NULL,img,x*32+50,y*32+55,0);
            point(sendBuf,&x,&y);
            ...
            img=newimage();
            getimage(img,"F:\\MyGame\\img/white.png");
            putimage_transparent(NULL,img,x*32+50,y*32+55,0);
            printf("w=%d %d\n",x,y);
...
int priority()
{
    ...
    img=newimage();
    getimage(img,"F:\\MyGame\\img/pri.png");
...
int color()
{
    ...
    cleardevice();
    img=newimage();
    getimage(img,"F:\\MyGame\\img/color.png");
    putimage(0,0,img);
...
void game_face()
{
    ...
    img1=newimage();
    getimage(img1,"F:\\MyGame\\img/qipan.png");
    putimage(30,25,img1);

    img2=newimage();
    getimage(img2,"F:\\MyGame\\img/1.png");
...
int win(int color)
{
    ...
    if(color==1)
    {
        getimage(img,"F:\\MyGame\\img/black_win.png");
        putimage_transparent(NULL,img,85,150,0);
    }
    else if(color==2)
    {
        getimage(img,"F:\\MyGame\\img/white_win.png");
        putimage_transparent(NULL,img,85,150,0);
    }
...
int Checkspace(node p, int role)
{
    ...
    GetType(x, y, 3-role, d);//电脑方四种方向的棋型
    for(int i=0; i<4; i++)
    {
        if(d[i]>=flex3)//活3
            return 1;
...
int Getspace(int depth,node s[10][100])
{
    ...
    int role=checkcolor(step+1);//玩家的颜色
...
void display(int x,int y,int C)
{
    ...
    if(C==1)
    {
        ...
        getimage(img,"F:\\MyGame\\img/w.png");
    ...
    else if(C==2)
    {
        ...
        getimage(img,"F:\\MyGame\\img/b.png");
        putimage_transparent(NULL,img,400,27,0);
...
int pc()
{
    ...
    //cleardevice();
    //int P=color(),nx,ny,step=0;
    PIMAGE img;
    game_face();
    P=2;
    C=1;
    int  n=2,step=0,nx,ny;
    //1我先手，2我后手
    //int n=priority();
    //cleardevice();
    //game_face();
...
int login()
{
    ...
    for(j=0; j<LEN; j++)
    {
        if(strcmp(nam,user[j].name)==0)
        {
            cleardevice();
            img=newimage();
            getimage(img,"F:\\MyGame\\img\\success.png");
    ...
    if(j==LEN)
    {
        cleardevice();
        img=newimage();
        getimage(img,"F:\\MyGame\\img\\register.png");
...
int regist()
{
    ...
    for( i=0; i<LEN; i++)
    {
        if(strcmp(user[i].name,nam)==0)
        {
            cleardevice();
            img=newimage();
            getimage(img,"F:\\MyGame\\img\\exist.png");
    ...
    if(i==LEN)
    {
        cleardevice();
        img=newimage();
        getimage(img,"F:\\MyGame\\img\\success1.png");
        putimage_transparent(NULL,img,170,220,0);
        getch();
        cleardevice();
        INDEX=0;
...
int other()
{
    ...
    img=newimage();
    getimage(img,"F:\\MyGame\\img\\login.png");
    putimage_transparent(NULL,img,170,220,0);
...
int face()
{
    ...
    img=newimage();
    getimage(img,"F:\\MyGame\\img/begin01.png");
    putimage(0,0,img);
            ...
            else if(x>=228&&x<=388&&y>=244&&y<=279)
            {
                ...
                for ( ; is_run(); delay_fps(60))
                {
                    while (mousemsg())
                    {
                        ...
                        setbkcolor(EGERGB(255,255,255));
                        img=newimage();
                        getimage(img,"F:\\MyGame\\img/begin.png");
